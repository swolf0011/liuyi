...
object NvWebViewX5Util {
    ...
    fun initWebView(
        webViewX5: WebView,
        url: String,
        js2JavaInterface: NvJS2JavaInterface,
        jsObj: String
    ) {
        val settings: WebSettings = webViewX5.getSettings()
        //设置JavaScrip
...
//        settings.blockNetworkImage = true
        ...
        webViewX5.setWebChromeClient(WebChromeClient())
        webViewX5.setWebViewClient(NvWebViewX5Client()) // 注册Js调用Java的方法
        webViewX5.addJavascriptInterface(js2JavaInterface, jsObj)
