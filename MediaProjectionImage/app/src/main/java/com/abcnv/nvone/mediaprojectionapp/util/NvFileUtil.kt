...
object NvFileUtil {
     ...
     *
     * @param file File
     * @param inSampleSize Int 1(1/1 size),2(1/2 size)，4(1/4 size)
     * @return Bitmap?
     */
     ...
     * @return ByteArray?
     */
    fun readByteArray(filePath: String, startIndex: Long, readSize: Int): ByteArray? {
        var raf: RandomAccessFile? = null
        try {
            if (startIndex >= 0 && readSize > 0) {
